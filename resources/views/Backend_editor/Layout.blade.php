...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-gray" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4  fs-4 fw-bold text-uppercase border-bottom text-primary"
                style="color: #8f66cc;">
                logo</div>
            ...
            class="fas fa-chart-line me-2 text-primary me-2 text-success"></i>  Add Course</a>
                <a href="#" class="list-group-item list-group-item-action bg-transparent " id="link"><i
                        class="fa-brands fa-creative-commons-share me-2 fa-lg" style="color: #8f66cc;"></i> Lessons</a>
                <a href="/Quizzes" class="list-group-item list-group-item-action bg-transparent " id="link"><i
                        class="fa-regular fa-stopwatch me-2 fa-lg" style="color: #8f66cc;"></i> Quizzes</a>
            ...
            class="fas fa-shopping-cart me-2 text-primary me-2 text-success"></i>  Add Quizze</a> -->
                <a href="#" class="list-group-item list-group-item-action bg-transparent " id="link"><i
                        class="fa-solid fa-list-check me-2 fa-lg" style="color: #8f66cc;"></i> Assignments</a>
                <a href="/Questions" class="list-group-item list-group-item-action bg-transparent " id="link"><i
                        class="fa-solid fa-clipboard-question me-2 fa-lg" style="color: #8f66cc;"></i> Questions</a>
            </div>
