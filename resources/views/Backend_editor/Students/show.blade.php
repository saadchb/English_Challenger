                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            ...
                            @else
                            <img alt="picture" src="{{ asset('storage/'. $student->picture) }}" style="height: 90px;width: 90px;" class="profile-user-img img-fluid img-circle">
                            @endif
                        </div>

                        <h3 class="profile-username text-center">{{$student->first_name}} {{$student->last_name}}</h3>

                        <p class="text-muted text-center">English student</p>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">About {{$student->first_name}}</a></li>
                                    ...
                                    <div class="col-6 ">
                                        <div class="info-box">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text">Course Enrolled</span>
                            ...
                            <div class="tab-pane" id="timeline">
                                ...
                                <div class="">
                                    <div class="card-body">
                                        ...
                                        <strong><i class="far fa-time-alt mr-1"></i> date of birth</strong>
