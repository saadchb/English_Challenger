            ...
            <div class="relative m-2">
                ...
                <div class="flex justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <a href="{{route('books.edit',$book->id)}}" target="_blank" rel="noopener noreferrer" class="text-sm font-medium text-green-600 flex items-center gap-x-1"><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
