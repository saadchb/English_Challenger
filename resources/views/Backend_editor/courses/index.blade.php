...
<div class="container-fluid mt--8">
    <div class="px-8 py-4">
        <h1 class="mt-2 mb-4 text-center">COURSE LIST</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
            ...
            <div class="relative m-2">
                ...
                <div class="mt-4 mb-4">
                    ...
                    <a class="mb-4 mt-2 text-sm text-gray-700 font-medium text-left line-clamp-2" href="#">{{$course->title}}</a>
                </div>
                <div class="flex justify-between">
                    <div class="flex items-center space-x-3">
                        <a href="{{route('Courses.edit',$course->id)}}" target="_blank"
                    ...
                    <form id="delete-form-{{$course->id}}" action="{{route('Courses.destroy',$course->id)}}" action="#" method="post">
                        @csrf
                        @method('DELETE')
