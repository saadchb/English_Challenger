                            ...
                            @if ($books->isEmpty())
                                ...
                                <div class="error-page text-center error-404 not-found">
                                    ...
                                    <div class="error-content">
                                        ...
                                        <a href="/E_Library" class="btn" style="background-color: #862b84;">Back to books
                                            Page</a>
                                    </div>
                                </div>
                            @else
                                    ...
                                    <li class="product ml-4">
                                        <div class="product-wrap">
                                            <a href="#" class="">
                                                ...
                                                @else
                                                    <img src="{{ asset('build/assets/images/shop/book.webp') }}"
                                                        alt="">
                                                @endif
                                            </a>
                            ...
                            <nav class="woocommerce-pagination">
                                <ul class="page-numbers">
                                    @if ($books->previousPageUrl())
                                        <li><a class="next page-numbers" href="{{ $books->previousPageUrl() }}"><i
                                                    class="fas fa-long-arrow-alt-left"></i></a></li>
                                    @endif
                                    @for ($i = 1; $i <= $books->lastPage(); $i++)
                                        <li><a class="page-numbers" href="{{ $books->url($i) }}">{{ $i }}</a>
                                        </li>
                                    @endfor
                                    @if ($books->nextPageUrl())
                                        <li><a class="next page-numbers" href="{{ $books->nextPageUrl() }}"><i
                        ...
                        <section id="woocommerce_product_search-2" class="widget woocommerce widget_product_search">
                            <form role="search" method="get" class="woocommerce-product-search" action="#">
                                ...
                                <input type="search" id="woocommerce-product-search-field-0" class="search-field"
                                    onchange="fom1.submit()" placeholder="Search school…" id="search1" name="search1">
                            ...
                            <form method="get" action="#">
                                <div class="price_slider_wrapper">
                                    ...
                                    <div class="price_slider_amount" data-step="10">
                                        ...
                                        <input type="text" id="max_price" name="max_price" value="90"
                                            data-max="90" placeholder="Max price" style="display: none;">
                        ...
                        <section id="woocommerce_layered_nav-2"
                            ...
                            <ul class="woocommerce-widget-layered-nav-list">
                                <li class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term "><a
                                        rel="nofollow" href="#">Blue</a> <span class="count">(4)</span></li>
                                ...
                                <li class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term "><a
                                        rel="nofollow" href="#">Green</a> <span class="count">(3)</span></li>
                                <li class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term "><a
                                        rel="nofollow" href="#">Red</a> <span class="count">(4)</span></li>
                                <li class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term "><a
                                        rel="nofollow" href="#">Yellow</a> <span class="count">(1)</span></li>
                            </ul>
                        </section>
                            ...
                            <ul class="product-categories nav flex-column">
                                <li class="cat-item cat-item-17 cat-parent nav-item"><a href="#"
                                    ...
                                    <ul class="children nav flex-column">
                                        ...
                                        <li class="cat-item cat-item-19 nav-item"><a href="#"
                                                class="nav-link">Hoodies</a></li>
                                        <li class="cat-item cat-item-18 nav-item"><a href="#"
                                                class="nav-link">Tshirts</a></li>
                                    </ul>
                                </li>
                                <li class="cat-item cat-item-22 nav-item"><a href="#" class="nav-link">Decor</a>
                                </li>
                                <li class="cat-item cat-item-21 nav-item"><a href="#" class="nav-link">Music</a>
                                </li>
                                <li class="cat-item cat-item-15 nav-item"><a href="#"
                                        class="nav-link">Uncategorized</a></li>
                            </ul>
                        </section>
                    </div>
                    <!-- product section end-->
