                                        ...
                                        <div class="product-wrap">
                                            ...
                                            @else
                                                <div class="product-btn-wrap">
                                                    ...
                                                    <a href="/cart"
                                                        class="submitButton button product_type_simple add_to_cart_button ajax_add_to_cart ">
                                                        <i class="fa fa-cart-arrow-down "></i>
                                                    </a>

                                                    <a href="/E_library/book/{{ $book->id }}"
                                                        class="button wish-list"><i class="fa fa-eye"></i></a>
                                                </div>
                                            @endif
                                            {{-- @endforeach --}}
                                        </div>
                    ...
                    <div class="col-lg-4 widget-area ">
                                ...
                                <div class="price_slider_wrapper">
                                    ...
                                    <div class="price_slider_amount" data-step="10">
                                        ...
                                        <div class="price_label">
                                            Price: <span id="min_price_label" class="from"></span> — <span
                                                id="max_price_label" class="to"></span>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                </div>
                        ...
                        <section id="woocommerce_product_search-2" class="widget woocommerce widget_product_search">
                            <form role="search" method="get" class="woocommerce-product-search" action="#">
                                ...
                                <button type="submit" style="background-color: #862b84;" value="Search"><i
