                    ...
                    <section id="primary" class="content-area col-lg-12">
                        @error('billing_first_name')
                            <div class="msg-error mt-lg-0 mt-md-0">
                                <div class="widget ">
                                    <div
                                        style=" font-size: large; display: inline-flex; width: auto;padding:1.3%;justify-content: center;">
                                                        ...
                                                        <div class="woocommerce-billing-fields__field-wrapper">
                                                            ...
                                                            <p class="form-row form-row-wide address-field update_totals_on_change form-group single-country validate-required"
                                                                ...
                                                                <label for="billing_country"
                                                                    class="control-label">Country<abbr class="required"
                                                            ...
                                                            <p class="form-row form-row-wide address-field form-group validate-required"
                                                                ...
                                                                <label for="billing_address_1"
                                                                    class="control-label">Street address<abbr
                                                            ...
                                                            <p class="form-row form-row-wide address-field form-group validate-required validate-state"
                                                                ...
                                                                <label for="billing_state"
                                                                    class="control-label">District<abbr class="required"
                                                                        title="required">*</abbr></label><span
                                                                    class="woocommerce-input-wrapper">
                                                            ...
                                                            <p class="form-row notes" id="order_comments_field"
                                                                data-priority=""><label for="order_comments"
                                                                    class="control-label">Order notes<span
                                                                        class="optional">(optional)</span></label><span
                                                                    class="woocommerce-input-wrapper">
                                                                    <textarea name="order_comments" class="input-text form-control input-lg" id="order_comments"
                                                ...
                                                <div id="payment" class="woocommerce-checkout-payment">
                                                    ...
                                                    <div class="form-row place-order">
                                                        ...
                                                        <input type="hidden" id="woocommerce-process-checkout-nonce"
                                                            ...
                                                            value="c75f934b1d"><input type="hidden"
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            paymentMethodRadios.forEach(function(radio) {
                radio.addEventListener("click", function() {
                    ...
                    var selectedPaymentBox = document.querySelector('.payment_box.payment_method_' +
