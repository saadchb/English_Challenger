                ...
                <div class="col-lg-8">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-feedback" role="tabpanel" aria-labelledby="nav-feedback-tab">
                            <div class="course-widget course-info">
                                <h4 class="course-title"><i class="fas fa-comments" aria-hidden="true"></i> Students
                                    Feedback</h4>
                                @foreach ($review as $rev)
                                    @if ($rev->course_id == $course->id)
                                        <div class="course-review-wrapper">
                                            <div class="course-review">
                                                <div class="profile-img">
                                                    <img src="{{ asset('build/assets/images/clients/user.png') }}"
                                                        alt="" class="img-fluid">
                                                </div>
                                                <div class="review-text">
                                                    <h5>{{ $rev->name }} <span
                                                            style="float: right;">{{ $rev->created_at }}</span></h5><br>
                                                    <div class="rating">
                        ...
                        <div class="comments-form p-5 mt-6" style="margin-top: 140px !important;">
                            ...
                            <form action="{{ route('course.store') }}" class="comment_form" method="Post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row form-row">
                                    <div
                                        class="form-group form-control h-auto rounded px-3 pt-3 pb-3 gd-rating-input-group">
                                        <div
                                            class="gd-rating-outer-wrap gd-rating-input-wrap d-flex justify-content-between flex-nowrap w-100">
                                            ...
                                            <div class="gd-rating gd-rating-input gd-rating-type-font-awesome">
                                                <span class="gd-rating-wrap d-inline-flex position-relative c-pointer">
                                                    ...
                                                    <span class="star" data-value="1"><i class="fas fa-star"
                                                            style="font-size:24px" aria-hidden="true"></i></span>
                                                ...
                                                <span class="gd-rating-text badge badge-light border"
                                                    style="font-size: larger;" data-title="Select a rating">Select a
                                                    rating</span>
                    ...
                    <div class="course-sidebar">
                        <div class="course-single-thumb">
                            ...
                            <div class="course-price-wrapper">
                                ...
                                <div class="buy-btn"><a href="{{route('buyCourse',$course->id)}}" class="btn btn-main btn-block">Buy This
                                        Course</a></div>
                        ...
                        <div class="course-widget course-share d-flex justify-content-between align-items-center">
                            ...
                            <ul class="social-share list-inline">
                                <li class="list-inline-item"><a href="#" class="share-btn"
                                        data-platform="facebook"><i class="fab fa-facebook"></i></a></li>
                                <li class="list-inline-item"><a href="#" class="share-btn"
                                        data-platform="twitter"><i class="fab fa-twitter"></i></a></li>
                                <li class="list-inline-item"><a href="#" class="share-btn"
                                        data-platform="linkedin"><i class="fab fa-linkedin"></i></a></li>
                                <li class="list-inline-item"><a href="#" class="share-btn"
                                        data-platform="pinterest"><i class="fab fa-pinterest"></i></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="course-block">
                            <div class="course-img">
                                <img src="{{ asset('storage/' . $course->img) }}" style="width:350px; height: 280px;"
                                    alt="" class="img-fluid">
