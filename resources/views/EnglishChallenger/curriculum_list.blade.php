...
<body>
                            ...
                            @isset($quizActive)
                                                ...
                                                value * 100
                                                        ...
                                                        <div id="error" style="display: none;"
                                                            ...
                                                            <div class="text-danger has-error" role="content"
                                                                data-sider-select-id="a76800fe-ece4-418b-ae38-7e80bab89cb6"> <i
                                                                    class="fas fa-warning text-danger mr-2"></i>Please answer
                                                                all
                                ...
                                @if ($retaking == 0)
                                                    <div id="div-start">
                                                        ...
                                                        <div>
                                                            <span class=" mr-4"><i class="fa-solid fa-puzzle-piece mr-2"></i></i> Questions:
                                                            {{ count($questions) }}</span>
                                                            <span class=" mr-4"><i class="fa-solid fa-clock mr-2"></i>
                                                            Duration: {{ $quizActive->duration }}</span>
                                                             <span class=" mr-4"><i class="fa-solid fa-signal mr-2"></i> Passing grade:
    ...
    <div class="accordion-item">
        ...
        if (retake) {
            ...
            setTimeout(removeSelectedClass, 15000);
        }
    </script>
