            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="about-content">
                        Welcome to EnglishChallenger, your ultimate English Language destination! Immerse in engaging video
                        quizzes focused on English language and culture, covering vocabulary, grammar, and pronunciation.
                        Our goal is to make learning a thrilling challenge. Our website is exclusively dedicated to
                        entertaining and educating beginners and those refining their English skills.

                        Join our immersive platform exploring vocabulary, grammar, idioms, expressions, and English culture.
                        Dive into captivating quizzes, riddles, and scientific insights, tailored for curious minds. Elevate
                        your English proficiency through our quizzes, exercises, and beginner-friendly content. Learning
                        should be enjoyable; come learn and enjoy every moment with EnglishChallenger!
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-10">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/90dMLavEFOM"
                    ...
                    <div class="testimonials-slides owl-carousel owl-theme">
                        <div class="review-item">
                            <div class="client-info">
                                ...
                                <p>I've thoroughly enjoyed my time on this website. The lessons are well-structured and easy
                                    to follow. The practical exercises have really helped me improve my English skills. The
                                    teachers are very attentive and responsive. I highly recommend this site to anyone
                                    looking to learn English effectively and enjoyably!"</p>
                                <div class="rating">
                        ...
                        <div class="review-item">
                            <div class="client-info">
                                <i class="bi bi-quote"></i>
                                <p>As a teacher on this site, I'm delighted to be able to help students improve their
                                    English. The platform offers many pedagogical tools that make teaching easier, such as
                                    interactive quizzes, videos, and practical exercises. Additionally, the support team is
                                    always there to answer my questions and provide support. I'm grateful to be part of this
                                    dynamic learning community.</p>
                                <div class="rating">
                                    <a href="#"><i class="fa fa-star"></i></a>
                                    <a href="#"><i class="fa fa-star"></i></a>
                                    <a href="#"><i class="fa fa-star"></i></a>
                        ...
                        <div class="review-item">
                            <div class="client-info">
                                ...
                                <p>I've been using this site for a few months now and I'm really impressed with the quality
                                    of teaching. The lessons are interactive and engaging. Additionally, the discussion
                                    forums are a great way to interact with other learners and practice the language. I feel
                                    much more confident in my English skills thanks to this site.</p>
                                <div class="rating">
                                    <a href="#"><i class="fa fa-star"></i></a>
                                    <a href="#"><i class="fa fa-star"></i></a>
                                    <a href="#"><i class="fa fa-star"></i></a>
                    ...
                    <div class="blog-item">
                        ...
                        <div class="blog-content">
                            ...
                            <p> "Ready for a taste of British English?
                                ...
                                here's your chance to explore the rich tapestry of British linguistic heritage . Stay tuned
                                for details!"</p>

                            <a href="#" class="btn btn-main btn-small"><i class="fa fa-plus-circle mr-2"></i>Read
                                More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item">
                        ...
                        <div class="blog-content">
                            ...
                            <p>English Learning for Curious Minds was first published 4 years ago today. Here is a summary
                                of how things have gone since then, and the main things we've done in 2023.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item">
                        ...
                        <div class="blog-content">
                            ...
                            <h2><a href="#">24 Unorthodox Ways To Stick To Your English Learning Goals in 2024</a>
                            </h2>
                            <p>Learning English is hard, and one of the hardest things about it is staying motivated. Here
                                are 24 ways that you can stay motivated and hit your goals.</p>
    ...
    <div class="course-item cat1 cat3 col-lg-4 col-md-6">
        <div class="course-block">
            <div class="course-img">
                <img src="{{ asset('storage/') }}/${table[i].img}" alt="" class="img-fluid">
