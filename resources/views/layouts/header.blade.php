                            ...
                            <ul class="list-unstyled d-flex">
                                ...
                                @if($count < 3) <li style="width: 16rem; color:#646a76; margin: 5px;">
                                    <div id="cart" class="card-body">
                                        ...
                                        <p class="card-text" style="max-height: 3.6em; overflow: hidden;">
                                            {{ $course->description }}
                                        </p> <a href="/course_detail/{{(int)$course->id}}" style="text-decoration: underline;">
                    ...
                    <ul class="list-unstyled d-flex">
                        <li id="li3" style="width: 18rem; color: #646a76; margin-bottom: 10px;">
                            <div class="card-body">
                                ...
                                <a href="#" class="card-link card-subtitle mb-2 text-muted disabled">More info:</a>
                                <a href="https://www.worldtesolacademy.com/" class="card-link">About TESOL/TEFOL</a>
                            </div>
                        </li>
                        <li>
                            <div class="card" style="width: 18rem;">
